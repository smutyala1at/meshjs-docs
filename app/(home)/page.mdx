...
<main className="flex flex-1 flex-col container mx-auto px-2 lg:px-4">
  ...
  <div className="flex flex-col gap-8">
    ...
    <div className="space-y-2">
      ...
      <Link className="underline underline-offset-4 decoration-2" href="/apis">Explore Mesh APIs ></Link>
    </div>
    ...
    <div className="space-y-2">
      ...
      <Link className="underline underline-offset-4 decoration-2" href="/apis/smart-contracts">Start using smart contracts ></Link>
    </div>
    ...
    <div className="space-y-2">
      ...
      <Link className="underline underline-offset-4 decoration-2" href="/apis/resources">Check out resources ></Link>
    </div>
  </div>
</main>