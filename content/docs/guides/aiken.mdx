...
First, we will create a new project. Please refer to <Link href="/apis/guides/nextjs">this guide</Link> for more information on creating a new Next.js project.
