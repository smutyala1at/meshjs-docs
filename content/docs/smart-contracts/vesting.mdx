...
To initialize the contract, we need to initialize a <Link href="https://meshjs.dev/providers">provider</Link>, `MeshTxBuilder` and `MeshVestingContract`.
...
Both on-chain and off-chain codes are open-source and available on <Link href="https://github.com/MeshJS/mesh/tree/main/packages/mesh-contract/src/vesting">Mesh Github Repository</Link>.
...
A <Link href="https://preprod.cardanoscan.io/transaction/e61815bcfe46ababf3d024ae470f779fa738cded55f02127b9e211847c77af8b">successful withdrawal</Link> will send the funds to the wallet that signed the transaction to withdraw the funds.
...
Example of a <Link href="https://preprod.cardanoscan.io/transaction/ede9f8176fe41f0c84cfc9802b693dedb5500c0cbe4377b7bb0d57cf0435200b">successful deposit transaction</Link>.
...
Example of a <Link href="https://preprod.cardanoscan.io/transaction/b108f91a1dcd1b4c0bc978fb7557fc23ad052f1681cca078aa2515f8ab01e05e">successful withdraw transaction</Link>.
