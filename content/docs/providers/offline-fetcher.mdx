...
Once data is added, you can use the fetch* methods just like with other providers such as <Link href="/apis/providers/blockfrost">BlockfrostProvider</Link>. This makes OfflineFetcher a drop-in replacement for testing and offline scenarios.
