...
We then need to initialize the transaction builder by creating a new instance of `MeshTxBuilder`. We need to pass the <Link href="/apis/providers">blockchain provider</Link> to the constructor.
